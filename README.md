...
Before using **Project Wallet**, ensure you have:

* Docker installed
* npm
* node.js

## Instructions for using Project Wallet

Get started with Project by {write the first step a user needs to start using the project. Use a verb to start.}.
